...
public class FragmentPerakende2 extends Fragment {
    ...
    float adet1,tutar,gram1,milyem;
    Button hesapla,ekle,bitir;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView= inflater.inflate(R.layout.fragment_perakende2, container, false);
        ...
        aSwitch=(Switch) myView.findViewById(R.id.switch1);

        adet=(EditText)myView.findViewById(R.id.editText_adet);
        gram=(EditText)myView.findViewById(R.id.editText_adet3);

        hesapla=(Button)myView.findViewById(R.id.button5);
        ekle=(Button) myView.findViewById(R.id.button3);
        bitir=(Button) myView.findViewById(R.id.button4);
        ...
        if(aSwitch.isChecked()==true){
            aSwitch.setTextOn("SATIŞ");
        }
        else {
            aSwitch.setTextOff("ALIŞ");
